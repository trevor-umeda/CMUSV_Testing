...
Factory.define :trevor, :parent => :person do |p|
  p.is_student 1
  p.is_part_time 0
  ...
  p.first_name "Trevor"
  p.last_name "Umeda"
  p.human_name "Trevor Umeda"
  p.email "trevor.umeda@sv.cmu.edu"
...
Factory.define :neha, :parent => :person do |p|
  ...
  p.masters_program  "SE"
  p.masters_track  "Tech"
  p.twiki_name "NehaSinha"
  p.first_name "Neha"
  p.last_name "Sinha"
  p.human_name "Neha Sinha"
  p.email "neha.sinha@sv.cmu.edu"
  p.webiso_account "nehasinh@andrew.cmu.edu"
end
